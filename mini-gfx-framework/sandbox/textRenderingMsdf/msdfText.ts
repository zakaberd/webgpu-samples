...
import msdfTextWGSL from './msdfText.wgsl?raw';
...
export class MsdfText {
  private bufferArray: Float32Array = new Float32Array(24);
  ...
  getRenderBundle() {
    if (this.bufferArrayDirty) {
      ...
      this.device.queue.writeBuffer(
        this.textBuffer,
        0,
        this.bufferArray.buffer as ArrayBuffer,
        this.bufferArray.byteOffset,
        this.bufferArray.byteLength
      );
    }
